...
reagent-desc-blackpepper = 通常用于给食物调味或让人打喷嚏。

reagent-name-vinegar = 醋
reagent-desc-vinegar = 常用于给食物调味。

reagent-name-rice = 大米
reagent-desc-rice = 坚硬的小白粒。

reagent-name-oil-olive = 橄榄油
reagent-desc-oil-olive = 粘稠且芳香。

reagent-name-oil = 油
reagent-desc-oil = 被厨师用于烹饪。

reagent-name-capsaicin-oil = 辣椒油
reagent-desc-capsaicin-oil = Capsaicin Oil是发现于多种辣椒中的成分。

reagent-name-frost-oil = 寒霜油
reagent-desc-frost-oil = 霜油是存在于寒辣椒中的成分，这是一种罕见的辣椒变异。
