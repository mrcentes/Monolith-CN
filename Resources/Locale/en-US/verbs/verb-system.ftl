verb-system-null-server-response = 实体不在视野范围内。你不应看到此信息。
...
verb-categories-buckle = 固定搭扣
verb-categories-unbuckle = 解除搭扣
verb-categories-rotate = 旋转
verb-categories-smite = 惩戒
verb-categories-tricks = 小把戏
verb-categories-transfer = 设置传输量
...
verb-categories-lever = 操纵杆
verb-categories-select-type = 选择类型
verb-categories-fax = 设置目标
verb-categories-power-level = 功率等级
verb-categories-adjust = 调整

verb-common-toggle-light = 开关灯光
verb-common-close = 关闭
verb-common-open = 打开
verb-common-close-ui = 关闭UI
verb-common-open-ui = 打开UI
