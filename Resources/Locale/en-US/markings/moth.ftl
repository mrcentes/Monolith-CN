...
marking-MothAntennasCharred = 触角（烧焦）
...
marking-MothAntennasMaple = 触角 (Maple)

marking-MothAntennasMoffra-moffra = 触角
marking-MothAntennasMoffra = 触角 (Moffra)

marking-MothAntennasOakworm-oakworm = 触角
marking-MothAntennasOakworm = 触角 (Oak Worm)

marking-MothAntennasPlasmafire-plasmafire = 触角
marking-MothAntennasPlasmafire = 触角 (Plasmafire)

marking-MothAntennasRoyal-royal = 触角
marking-MothAntennasRoyal = 触角 (Royal)

marking-MothAntennasStriped-striped = 触角
marking-MothAntennasStriped = 触角（条纹）

marking-MothAntennasWhitefly-whitefly = 触角
marking-MothAntennasWhitefly = 触角（粉虱）

marking-MothAntennasWitchwing-witchwing = 触角
marking-MothAntennasWitchwing = 触角 (魔女之翼)

marking-MothAntennasUnderwing-underwing_primary = 主要
marking-MothAntennasUnderwing-underwing_secondary = 次要
marking-MothAntennasUnderwing = 触角 (后翅)
...
marking-MothWingsCharred = 翅膀（烧焦）

marking-MothWingsDbushy-dbushy_primary = 主要
marking-MothWingsDbushy-dbushy_secondary = 次要
marking-MothWingsDbushy = 翅膀（深色 & 浓密）

marking-MothWingsDeathhead-deathhead_primary = 主要
marking-MothWingsDeathhead-deathhead_secondary = 次要
marking-MothWingsDeathhead = 翅膀（骷髅头）

marking-MothWingsFan-fan = 翅膀
marking-MothWingsFan = 翅膀 (扇状)

marking-MothWingsDfan-dfan = 翅膀
marking-MothWingsDfan = 翅膀（暗色与扇形）

marking-MothWingsFeathery-feathery = 翅膀
marking-MothWingsFeathery = 翅膀（羽毛状）

marking-MothWingsFirewatch-firewatch_primary = 主要
marking-MothWingsFirewatch-firewatch_secondary = 次要
marking-MothWingsFirewatch = 翅膀 (Firewatch)

marking-MothWingsGothic-gothic = 翅膀
marking-MothWingsGothic = 翅膀（哥特式）
...
marking-MothWingsMaple-maple_primary = 主要
marking-MothWingsMaple-maple_secondary = 次要
marking-MothWingsMaple = 翅膀 (枫叶)

marking-MothWingsMoffra-moffra_primary = 主要
marking-MothWingsMoffra-moffra_secondary = 次要
marking-MothWingsMoffra = 翅膀 (Moffra)

marking-MothWingsOakworm-oakworm = 翅膀
marking-MothWingsOakworm = 翅膀 (栎虫)
