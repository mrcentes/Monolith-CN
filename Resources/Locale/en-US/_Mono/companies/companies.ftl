...
drake-industries-description = 效率、利润、可靠性。德雷克工业曾是一个重要的贸易公司，如今已成为该行业最大的工业巨头。从流线型的民用飞船设计到材料精炼，它主要通过推动周边冲突来维持自身运转。官方上，公司不鼓励员工进行任何形式的敌对行为。它向所有有能力的飞行员、工程师和愿意加入其旗帜下的私人保安承诺轻松赚钱。然而，当工作环境包含紧迫到令人窒息的截止期限、无法休息上厕所以及在肮脏的睡袋上睡觉时，不要感到意外。
